...
${OBJECTDIR}/src/lua/LuaSensorScript.o: src/lua/LuaSensorScript.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/lua/LuaSensorScript.o src/lua/LuaSensorScript.cpp

${OBJECTDIR}/src/sensor/OssSensor.o: src/sensor/OssSensor.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/sensor
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sensor/OssSensor.o src/sensor/OssSensor.cpp
